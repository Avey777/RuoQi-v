...
REPLACE INTO `ws_workspace` (`id`, `tenant_id`, `name`, `description`, `status`, `updater_id`, `updated_at`, `creator_id`, `created_at`, `del_flag`, `deleted_at`) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '默认工作区', '系统默认工作区', 0, NULL, '2027-01-01 00:00:00', NULL, '2027-01-01 00:00:00', 0, NULL);
"
...
REPLACE INTO `ws_role` (`id`, `workspace_id`, `name`, `code`, `description`, `sort`, `status`, `updater_id`, `updated_at`, `creator_id`, `created_at`, `del_flag`, `deleted_at`) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '空间管理员', 'workspace_admin', '默认工作区管理员角色', 1, 0, NULL, '2027-01-01 00:00:00', NULL, '2027-01-01 00:00:00', 0, NULL);
"
...
REPLACE INTO `ws_member` (`workspace_id`, `user_id`, `joined_at`, `status`, `updater_id`, `updated_at`, `creator_id`, `created_at`, `del_flag`, `deleted_at`) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '2027-01-01 00:00:00', 0, NULL, '2027-01-01 00:00:00', NULL, '2027-01-01 00:00:00', 0, NULL);
"
...
REPLACE INTO `ws_department` (`id`, `workspace_id`, `parent_id`, `name`, `code`, `description`, `sort`, `status`, `updater_id`, `updated_at`, `creator_id`, `created_at`, `del_flag`, `deleted_at`) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '0', '默认部门', 'default', '系统默认部门', 1, 0, NULL, '2027-01-01 00:00:00', NULL, '2027-01-01 00:00:00', 0, NULL);
"
...
REPLACE INTO `ws_position` (`id`, `workspace_id`, `name`, `code`, `description`, `sort`, `status`, `updater_id`, `updated_at`, `creator_id`, `created_at`, `del_flag`, `deleted_at`) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', '默认岗位', 'default', '系统默认岗位', 1, 0, NULL, '2027-01-01 00:00:00', NULL, '2027-01-01 00:00:00', 0, NULL);
"
