...
pub:
	...
	auth_type  i16     @[comment: 'The auth type, supported plain, CRAMMD5 | 鉴权类型, 支持 plain, CRAMMD5'; omitempty; required; sql: 'auth_type'; sql_type: 'smallint']
	...
	tls        i16     @[comment: 'Whether to use TLS | 是否采用 tls 加密'; default: 0; omitempty; sql: 'tls'; sql_type: 'smallint']
	is_default i16     @[comment: 'Is it the default provider | 是否为默认提供商'; default: 0; omitempty; sql: 'is_default'; sql_type: 'smallint']
