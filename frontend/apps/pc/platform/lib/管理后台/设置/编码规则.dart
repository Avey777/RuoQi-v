...
/// 编码规则 (设置/编码规则)
class jOWxGolr4Page extends StatelessWidget {
  const jOWxGolr4Page({super.key});
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      '1 代表C端商城，86代表中国站点\n设备号15(取最后10位)+10位时间戳+序号(同一时间戳时自动排序, 限制两位；超出两位数需要用户安全验证后重新生成)',
                      textAlign: TextAlign.left,
                      style: TextStyle(
                        fontSize: 12,
                        color: Color(0xFF4C5773),
