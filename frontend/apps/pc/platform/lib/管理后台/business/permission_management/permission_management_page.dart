...
import '../user_management/user_management_models.dart';
import '../user_management/user_management_widgets.dart';
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        ...
        return AlertDialog(
          ...
          content: Text(
            '「$_role」将新增 $added 个权限，取消 $removed 个权限。\n'
            '你确定要保存修改吗？',
          ),
          actions: [
            TextButton(
