...
/// 打开单号规则编辑弹窗（700×500 居中模态，参照原型与规范弹窗样式）。
Future<void> showEncodingRuleEditDialog(
  ...
  return showDialog<void>(
    ...
    builder: (_) => EncodingRuleEditDialog(rule: rule),
  );
}

/// 单号规则编辑弹窗。
class EncodingRuleEditDialog extends StatefulWidget {
  const EncodingRuleEditDialog({super.key, required this.rule});

  final EncodingRule rule;

  @override
  State<EncodingRuleEditDialog> createState() => _EncodingRuleEditDialogState();
}

class _EncodingRuleEditDialogState extends State<EncodingRuleEditDialog> {
